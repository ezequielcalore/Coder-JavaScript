...
const coef_a = parseFloat(prompt("Ingrese el coeficiente a"))
const coef_b = parseFloat(prompt("Ingrese el coeficiente b"))
...
// Cantidad de raíces de la función cuadrática
...
while (menu !== 6) {
    switch(menu) {
        ...
        case 4:
            ...
            break
        case 5:
            alert("El conjunto imagen de A es: {" + imagen_A + "}")
        default:
            break
    }
